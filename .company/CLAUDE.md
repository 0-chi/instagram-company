...
- InstagramビジネスでSNSを活用した収益化を目指している
- 収益化の手段として、PR案件・アフィリエイト・自社商品販売などが考えられる
- コンテンツ管理（投稿ネタ・スケジュール・分析）が重要な業務
- フォロワー増加とエンゲージメント改善が収益化への近道
- マーケティング部門やクリエイティブ部門の追加が将来的に有効かもしれない
